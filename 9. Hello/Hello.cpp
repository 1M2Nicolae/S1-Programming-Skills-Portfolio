...
// Future reading and practice how to call a function w3schools - https://www.w3schools.com/cpp/cpp_functions.asp

void hello(){ // return tipe void
  cout << "Hello" << endl; // console output
}
