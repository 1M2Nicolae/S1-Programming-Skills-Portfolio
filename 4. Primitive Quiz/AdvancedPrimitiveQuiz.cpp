...
// Function to convert string to lowercase furure reading : 
// geeksforgeeks -  https://www.geeksforgeeks.org/cpp/tolower-function-in-cpp/


// defining function and convert inp c to out C
string toLowerCase(string str) { 
    for (char& c : str) { // can use auto or char in our case
        c = tolower(c);
    }
    return str;
}
